...
#define MODULE_NAME "EditorGizmo"
#define LOCTEXT_NAMESPACE "FEditorGizmoModule"

void FEditorGizmoModule::StartupModule()
{
...
void FEditorGizmoModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FEditorGizmoModule, EditorGizmo)
